...
if ($(".tooltip-demo").tooltip({
        ...
        i.slideToggle(20), e.toggleClass("fa-chevron-up").toggleClass("fa-chevron-down"), o.toggleClass("").toggleClass("border-bottom"), setTimeout(function () {
    ...
    var gohome = '<div class="gohome"><a class="animated bounceInUp" href="/backManage/index" title="返回首页"><i class="fa fa-home"></i></a></div>';
    $("body").append(gohome)
}
