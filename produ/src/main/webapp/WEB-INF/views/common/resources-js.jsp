...
<script src="../../static/js/tree_table/jeeplus.js"></script>
<script src="../../static/js/tree_table/mustache.min.js"></script>
<script src="../../static/js/tree_table/jquery.treeTable.min.js"></script>

<!-- jquery-json -->
<script type="text/javascript" src="../../static/js/jquery-json/jquery.json.min.js"></script>