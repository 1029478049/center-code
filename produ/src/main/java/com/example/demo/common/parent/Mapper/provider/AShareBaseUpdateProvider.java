package com.example.demo.common.parent.Mapper.provider;
...
public class AShareBaseUpdateProvider extends MapperTemplate {
  
    //继承父类的方法
    public AShareBaseUpdateProvider(Class<?> mapperClass, MapperHelper mapperHelper) {
