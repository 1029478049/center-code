...
import com.example.demo.common.parent.Mapper.provider.AShareSpecialProvider;
 ...
 * @param <T> 不能为空
 */
public interface AShareInsertListMapper<T> {
    ...
    @InsertProvider(type = AShareSpecialProvider.class, method = "dynamicSQL")
